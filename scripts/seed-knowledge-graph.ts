...
const FEATURES: Feature[] = [
  ...
  { name: 'Tiers & Leaderboards', prd: '§2.6', phase: 'Backend Core', status: 'partial',
    ...
    note: 'Initiator→Legend tiers; Redis global+org live for Act 1 (40 XP #1); Unranked until first Act merge; 45-day reset still pending' },
  ...
  { name: 'Dashboard Page', prd: '§4.1', phase: 'Frontend', status: 'partial',
    ...
    roles: ['Contributor'],
    note: 'Connect Repositories + pending eval + Act clock live; realtime and org sidebar still pending' },
