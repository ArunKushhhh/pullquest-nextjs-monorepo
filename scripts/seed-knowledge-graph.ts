...
const FEATURES: Feature[] = [
  ...
  { name: 'Issue Staking System', prd: '§2.2', phase: 'Backend Core', status: 'partial',
    ...
    webhooks: ['issues'],
    note: 'Mandatory Stake-X label; exact stake; multi-contributor per issue' },
  { name: 'PR Lifecycle & Resolution', prd: '§2.3', phase: 'Backend Core', status: 'partial',
    ...
    note: '5 outcomes with automated refund/deduction/compensation logic' },
  ...
  { name: 'Coin Economy', prd: '§2.7', phase: 'Backend Core', status: 'partial',
    ...
    roles: ['Contributor'],
    note: '150 signup + 100 monthly; earned/purchased/locked split; bundles once per Act' },
  ...
  { name: 'Grafana Dashboards', prd: '§8.5', phase: 'Observability', status: 'partial',
    ...
    note: 'API overview, coin economy, leaderboard/XP, worker queues; §8.5 alert rules seeded as GrafanaAlert nodes' },
